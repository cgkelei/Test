...
void OnInit() {
	GL_CHECK_ERRORS
		//load the shader
	//shader.LoadFromFile( GL_VERTEX_SHADER,"./shaders/vVertex.vet" );
	//shader.LoadFromFile( GL_FRAGMENT_SHADER, "./shaders/fragment.fra");

	shader.LoadFromFile( "./shaders/vVertex.vet",GL_VERTEX_SHADER );
	shader.LoadFromFile( "./shaders/fragment.fra",GL_FRAGMENT_SHADER );
